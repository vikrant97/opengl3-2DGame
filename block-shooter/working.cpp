...
float score=0,move1=0,move2=0,change=0,speed=0.05,current_time,rotation_angle=0,last_update_time,changered[1000]={4.5},changegreen[1000]={4.5},changeblack[1000]={4.5},xred[1000],xgreen[1000],xblack[1000],bulletx[1000],bullety[1000],adjusty[1000],rotationBullet[1000];
void initialise()
{
	int i;
	srand(time(NULL));
